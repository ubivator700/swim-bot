...
def kid_price(user_data):
    ...
    if user_data['kid_type'] == 'Групповые':
        ...
        if user_data['user_pool'] == 'СК «Орбита»':
            worker.send_msg(user_data['user_id'], 'Групповые тренировки (стоимость за месяц) в СК «Орбита»:\n\nРазовое занятие – 1 800\nРаз в неделю – 5 500\nДва раза в неделю – 12 900')
            worker.send_msg(user_data['user_id'], user_data['user_name']+', пора тренироваться. Приглашаю тебя на пробную тренировку в школу плавания Swim Shot. Она стоит всего 5500₽.')
